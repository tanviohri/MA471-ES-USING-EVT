...
ad.test(blocks)
```
gevFit and gumbelFit estimate the parameters either by the probability weighted moment method("pwm") or by maximum log likelihood estimation ("mle"). We have used PWM method here.
```{r}
